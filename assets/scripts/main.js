...
function initFormHandler() {
	...
	form.querySelectorAll('button')[0].addEventListener("click", (e) =>{
		let data = new FormData(form);
		let recipe = new Object();
		recipe.imgSrc = data.get('imgSrc');
		recipe.imgAlt = data.get('imgAlt');
		recipe.titleTxt = data.get('titleTxt');
		recipe.titleLnk = data.get('titleLnk');
		recipe.organization = data.get('organization');
		recipe.rating = data.get('rating');
		recipe.numRatings = data.get('numRatings');
		recipe.lengthTime = data.get('lengthTime');
	...
	let clear = form.querySelector("button.danger");
